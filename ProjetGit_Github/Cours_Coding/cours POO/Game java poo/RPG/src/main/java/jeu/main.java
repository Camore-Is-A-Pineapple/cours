...
public class main {
	...
	public static void main (String [] args) {
            ...
            //préparation du upCasting
		Hero hero1;
		Hero hero2;
		
		System.out.println("Veuillez sélectionner votre première classe (Guerrier, Mage, Assassin ou Romuald) : ");
		...
		System.out.println("------------------------------------------------------------------");
		System.out.println("Veuillez sélectionner votre seconde classe (Guerrier, Mage, Assassin ou Romuald) : ");
		...
		if (hero1 != null && hero2 != null) {
			/*
                    ...
                    if (hero1 instanceof Romuald) {
				Hero Romuald = (Romuald) hero1;
				Romuald.taper();
			} else if (hero1 instanceof Mage) {
				Hero Mage = (Mage) hero1;
				Mage.taper();
			} if (hero2 instanceof Romuald) {
				Hero Romuald = (Romuald) hero2;
				Romuald.taper();
	...
	//gestion des erreurs de saisie dans la console
	public static Hero getPlayerClass(String n) {
		Hero myHero = null;
		if (n.equals("Guerrier")) {
			myHero = new Guerrier();
		} else if (n.equals("Mage")) {
			myHero = new Mage();
		} else if (n.equals("Assassin")) {
			myHero = new Assassin();
		} else if (n.equals("Romuald")) {
			myHero = new Romuald ();
                } else {
